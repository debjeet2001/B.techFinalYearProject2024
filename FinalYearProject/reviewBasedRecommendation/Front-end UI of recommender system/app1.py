...
# Load the dataset for getting the columns
data = pd.read_csv('reviews.csv')
data_encoded = pd.get_dummies(data, columns=['Airline', 'Route', 'Class'])
model_columns = data_encoded.drop('Recommended', axis=1).columns
